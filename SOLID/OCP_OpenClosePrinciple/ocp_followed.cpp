...
// What I could understand: A class shoudl be designed in such a manner ,basically Don’t edit old classes every time a new variation is needed
// that the plug and play model is being ensured properly and for future 
